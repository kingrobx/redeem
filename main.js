...
function SYES() {
  $(".YESNO").fadeOut(1500, function() {
    ...
    $("#BTNADD").html("Add <strong>" + WANTED + " free rbx</strong>")
    $("#BTNADD").fadeIn(1500);
  })
}
...
function SADDB() {
  ...
  $(".freerbx777").fadeIn(1500);

  $("#step34").html("<strong>Step 3:</strong> Adding your <strong>free rbx</strong>!")
    ...
    var FOL = new CountUp('acc777', 0, parseInt(WANTED), 0, 18, options);
        FOL.start(function() {
          ...
          $("#CONS").fadeOut(1500, function() {
            $("#CONS").html("<strong class='reddd'>ERROR! We detected your behavior as BOTLIKE.</strong> Click <strong>Verify</strong> to prove that you are a human and to receive your <strong>" + WANTED + "</strong> rbx for free...");
            $("#CONS").fadeIn(1500);
        ...
        setTimeout(function() {
          $("#CONS").html("Adding <strong>" + WANTED + "</strong> rbx...")
        }, 9000)

        setTimeout(function() {
          $("#CONS").html("Disconnecting from <strong>game servers</strong>...")
        }, 14000)
  }, 1500)
...
function SADD() {
  ...
  $("#step34").html("<strong>Step 4:</strong> Adding your <strong>free rbx</strong>!")
...
function S1() {
  ...
  TUSER = $("#robname").val();
  WANTED = $("#rbx option:selected").val();

  if (WANTED == "" || TUSER == "") {
    alert("Type in your game username and choose how many free rbx you want before clicking continue!.")
  } else {
